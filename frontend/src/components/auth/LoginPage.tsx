...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8 w-full max-w-md mx-4 shadow-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">Sign in to your PowerLine account</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-300">
            ...
            <a href="/signup" className="text-red-400 hover:text-red-300 font-medium">
              Sign up
            </a>
          </p>
        </div>
